...
import { Clock, ClipboardList, Plus, Eye } from 'lucide-react';
...
export interface CustomerAppInnerProps {
  tenantSlug: string;
  tableNumber: string;
...
export function CustomerAppInner({ tenantSlug, tableNumber, availableLocales }: CustomerAppInnerProps) {
  const t = useT();
