  ...
  return (
    <div className="relative inline-flex items-center">
      ...
      <select
        ...
        className="appearance-none bg-bg-surface text-text text-xs font-medium border border-border rounded-[var(--radius-chip)] pl-7 pr-6 py-1.5 min-h-[var(--hit-sm)] cursor-pointer hover:border-border-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-colors"
