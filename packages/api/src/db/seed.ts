...
function seed() {
  ...
  const itemDefs: ItemDef[] = [
    ...
    { name: 'Fresh Lemonade', description: 'House-made with mint', price: 5.0, category: 'Drinks', sortOrder: 1 },
    { name: 'Craft Beer', description: 'Local pale ale, 500ml', price: 8.0, category: 'Drinks', sortOrder: 2 },
    { name: 'House Wine', description: 'Red or white, 150ml glass', price: 12.0, category: 'Drinks', sortOrder: 3 },
  ];
